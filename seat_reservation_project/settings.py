"""
Django settings for seat_reservation_project project.
...
ROOT_URLCONF = 'seat_reservation_project.urls'
...
WSGI_APPLICATION = 'seat_reservation_project.wsgi.application'
